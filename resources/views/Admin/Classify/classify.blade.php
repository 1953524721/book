...
<table width="99%" border="0" cellpadding="0" cellspacing="0" class="CContent">
  <tr>
      <th class="tablestyle_title" >添加图书分类</th>
  </tr>
  <tr>
    <td class="CPanel">
        ...
        <tr><td align="left">
            ...
            <TD width="100%">
                ...
                <legend>图书分类添加</legend>
                      <table border="0" cellpadding="2" cellspacing="1" style="width:100%">

                      <tr>
                        <td nowrap align="right" width="15%">分类名称:</td>
                        <td width="35%"><input name='classify_name' type="text" class="text" style="width:154px" value="" placeholder="请输入要添加的图书分类名称" />
