...
<form action="insd" method="post" enctype="multipart/form-data">
<input type="hidden" name="_token" value="<?= csrf_token(); ?>">
<table width="75%" border="1" cellpadding="0" cellspacing="0" class="list_table">
    <tr>
        <th width="300">工作</th>
        <td><input type="text" class="input-text lh30" name="work" placeholder="工作"></td>
    </tr>
    <tr>
        <th width="300">生日</th>
    ...
    <tr>
        <th width="300">学校</th>
        <td><input type="text" class="input-text lh30" name="school" placeholder="学校"  maxlength="20" minlength="2"></td>
    </tr>
    <tr>
        <th width="300">邮箱</th>
        <td><input type="eamil" id="eamil" class="input-text lh30" placeholder="邮箱" name="eamil" >
            <span class="eamil"></span>
        </td>
    </tr>
    <tr>
        <th width="300">手机号</th>
        <td><input type="tel"  class="input-text lh30" name="iphone" placeholder="邮箱" id="phone" >
            <sapn class="phone"></sapn></td>
    </tr>
    <tr>
        <th width="300">个性签名</th>
        <td><input type="text"  class="input-text lh30" name="autograph" placeholder="个性签名" maxlength="200" minlength="4"></td>
    </tr>
    <tr>
        <th width="300">个人说明</th>
        <td><input type="text"  class="input-text lh30" name="explain" placeholder="个人说明" maxlength="200" minlength="4" ></td>
    </tr>
    <tr>
